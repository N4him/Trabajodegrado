...
/// Widget de fondo con gradiente para el módulo de habits
class HabitsGradientBackground extends StatelessWidget {
  final Widget child;

  const HabitsGradientBackground({
    super.key,
    required this.child,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ...
        // Iconos decorativos motivacionales con colores del ajolote
        Positioned(
          top: 50,
          right: 30,
          child: Icon(
        ...
        Positioned(
          ...
          child: Icon(
            ...
            color: isDark
                ...
                : const Color(0xFFFFB6B6).withOpacity(0.22),
          ),
        ),
        ...
        Positioned(
          ...
          child: Icon(
            ...
            size: 35,
            color: isDark
                ? const Color(0xFFFFBB99).withOpacity(0.12)
                : const Color(0xFFFFDDCC).withOpacity(0.22),
          ),
        ),
        ...
        Positioned(
          ...
          child: CustomPaint(
            ...
            painter: HabitsWavesPainter(isDark: isDark),
          ),
        ),
...
/// Painter personalizado para ondas decorativas de habits
class HabitsWavesPainter extends CustomPainter {
  final bool isDark;

  HabitsWavesPainter({required this.isDark});
